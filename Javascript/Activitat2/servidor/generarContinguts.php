<?php
// Frases de contingut de les que se selecciona aleat�riamente una de ellas
...
// Generar un n�mero aleatori entre 0 y el n�mero total de frases disponibles
srand((double)microtime()*1000000);
$numeroAleatori = rand(0, count($frases)-1);

// La resposta d'aquest script consisteix en una frase seleccionada aleat�riamente
